...
public class BlockInventoryFragment extends Fragment{
    ...
    private String round(float f){
        ...
        if(f >= 10000000){
            ...
            return Strings.fixed((float) Math.floor(f / 100000) / 10f, 1) + "[gray]" + Core.bundle.getOrNull("unit.millions") + "[]";
        }else if(f >= 10000){
            return (int)(f / 1000) + Core.bundle.getOrNull("unit.thousands");
        }else if(f >= 1000){
            return Strings.fixed((float) Math.floor(f / 100) / 10f, 1) + Core.bundle.getOrNull("unit.thousands");
        }else{
            return (int)f + "";
        }
    }
